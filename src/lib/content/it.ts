  ...
  pages: {
    home: {
      ...
      estate: {
        ...
        title: "Tanti livelli. Un solo mare.",
        lead: "La Fenice nel paesaggio di Positano. Esplora la costa e il paese, poi avvicinati alle terrazze e segui le scale fino alla piccola cala.",
        study: "Studio 3D illustrativo · non in scala",
        disclaimer: "Il contesto usa dati geografici aperti; altezze degli edifici, dettagli di La Fenice e scale sono interpretativi, in attesa di riprese sul posto. Non è una mappa per orientarsi.",
        posterAlt: "Paesaggio 3D di Positano con l’abitato, i rilievi costieri e La Fenice sul pendio, dalle terrazze alla spiaggia privata.",
        open: "Esplora in 3D", close: "Torna all’immagine", loading: "Prepariamo la vista 3D…",
        error: "La vista 3D non è disponibile. Puoi continuare a esplorare l’immagine e leggere le tappe.",
        help: "Trascina in orizzontale per ruotare. Scegli una tappa per avvicinarti; usa i pulsanti per ruotare e ingrandire.",
        reset: "Vista d’insieme", rotateLeft: "Ruota a sinistra", rotateRight: "Ruota a destra", zoomIn: "Avvicina", zoomOut: "Allontana",
        stops: [
          { title: "L’arrivo", text: "Il percorso comincia dalla strada, nella parte alta della proprietà. Da qui si scende verso la casa." },
          { title: "Camere e terrazze", text: "I volumi della casa seguono il pendio. Le scale collegano camere e terrazze su livelli differenti." },
          { title: "Giardini e scale", text: "Tra il verde, rampe e pianerottoli accompagnano la discesa. La linea colorata è un percorso illustrativo, non un tracciato rilevato." },
          { title: "La piscina nella roccia", text: "Più in basso, la piscina con acqua di mare incontra la parete rocciosa e la vegetazione." },
          { title: "La spiaggia privata", text: "La discesa prosegue fino alla piccola cala di ciottoli, ai piedi della scogliera. Al ritorno, il percorso è in salita." },
          { title: "Positano e la costa", text: "Allarga lo sguardo verso l’abitato e i rilievi intorno a Positano. La costa e le impronte degli edifici seguono dati aperti; facciate e altezze sono ricostruzioni indicative." },
        ],
      },
    },
    rooms: {
