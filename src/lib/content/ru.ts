...
export const russianContent = {
  ...
  pages: {
    home: {
      ...
      stepsNotice: {
        title: "Обратите внимание на лестницы",
        text: "La Fenice расположена на нескольких уровнях, соединённых многочисленными лестницами. Проживание здесь может не подойти людям с ограниченной подвижностью или тем, кому трудно пользоваться лестницами. Пожалуйста, свяжитесь с нами до бронирования, чтобы вместе обсудить ваши потребности.",
      },
      estate: {
        eyebrow: "Знакомство с территорией", title: "Разные уровни. Одно море.",
        lead: "La Fenice в пейзаже Позитано. Осмотрите город и побережье, затем приблизьтесь к террасам и проследите путь по лестницам до маленькой бухты.",
        study: "Иллюстративная 3D-модель · не в масштабе",
        disclaimer: "Окрестности основаны на открытых геоданных. Высоты зданий, детали La Fenice и лестницы показаны приблизительно и требуют съёмки на месте. Это не навигационная карта.",
        posterAlt: "Трёхмерный пейзаж Позитано с городом, прибрежными горами и La Fenice, от террас до частного пляжа.",
        open: "Посмотреть в 3D", close: "Вернуться к изображению", loading: "Подготовка 3D-вида…",
        error: "3D-вид недоступен. Изображение и описания всех остановок остаются доступны.",
        help: "Проведите по горизонтали для поворота. Выберите остановку или используйте кнопки поворота и масштаба.",
        reset: "Общий вид", rotateLeft: "Повернуть влево", rotateRight: "Повернуть вправо", zoomIn: "Приблизить", zoomOut: "Отдалить",
        stops: [
          { title: "Прибытие", text: "Маршрут начинается у дороги в верхней части территории. Отсюда лестницы ведут вниз к дому." },
          { title: "Номера и террасы", text: "Здания расположены вдоль склона. Лестницы соединяют номера и террасы на разных уровнях." },
          { title: "Сады и лестницы", text: "Лестничные пролёты и площадки проходят среди зелени. Цветная линия — иллюстрация, а не точный маршрут." },
          { title: "Бассейн у скалы", text: "Ниже находится бассейн с морской водой у скальной стены, в окружении зелени." },
          { title: "Частный пляж", text: "Спуск продолжается до маленькой галечной бухты у подножия скал. Обратный путь идёт в гору." },
          { title: "Позитано и побережье", text: "Посмотрите на Позитано и окружающие его склоны. Береговая линия и контуры зданий основаны на открытых данных; фасады и высоты воссозданы приблизительно." },
        ],
      },
    },
    rooms: {
