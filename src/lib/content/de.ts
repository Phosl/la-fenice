  ...
  pages: {
    home: {
      ...
      estate: {
        ...
        lead: "La Fenice in der Landschaft von Positano. Entdecken Sie den Ort und die Küste, gehen Sie näher an die Terrassen heran und folgen Sie den Treppen zur kleinen Bucht.",
        study: "Illustrative 3D-Studie · nicht maßstabsgetreu",
        disclaimer: "Die Umgebung basiert auf offenen Geodaten. Gebäudehöhen, Details von La Fenice und Treppen sind interpretativ und müssen vor Ort überprüft werden. Keine Navigationskarte.",
        posterAlt: "3D-Küstenlandschaft von Positano mit dem Ort, Berghängen und La Fenice, von den Terrassen bis zum Privatstrand.",
        open: "In 3D entdecken", close: "Zurück zum Bild", loading: "Die 3D-Ansicht wird vorbereitet…",
        error: "Die 3D-Ansicht ist nicht verfügbar. Das Bild und die Beschreibungen bleiben zugänglich.",
        help: "Zum Drehen horizontal ziehen. Wählen Sie eine Station oder verwenden Sie die Dreh- und Zoomtasten.",
        reset: "Gesamtansicht", rotateLeft: "Nach links drehen", rotateRight: "Nach rechts drehen", zoomIn: "Vergrößern", zoomOut: "Verkleinern",
        stops: [
          { title: "Die Ankunft", text: "Der Weg beginnt an der Straße im oberen Teil des Anwesens. Von hier führen Treppen zum Haus hinunter." },
          { title: "Zimmer und Terrassen", text: "Die Gebäude folgen dem Hang. Treppen verbinden Zimmer und Terrassen auf unterschiedlichen Ebenen." },
          { title: "Gärten und Treppen", text: "Treppenläufe und Absätze führen durch das Grün. Die farbige Linie ist eine Illustration, kein vermessener Weg." },
          { title: "Der Pool am Felsen", text: "Weiter unten liegt der Meerwasserpool an der Felswand, umgeben von mediterranem Grün." },
          { title: "Der Privatstrand", text: "Der Abstieg führt bis zur kleinen Kiesbucht am Fuß der Klippen. Der Rückweg führt bergauf." },
          { title: "Positano und die Küste", text: "Blicken Sie über das Anwesen hinaus auf Positano und die umliegenden Hänge. Küstenlinie und Gebäudegrundrisse basieren auf offenen Daten; Fassaden und Höhen sind beispielhaft rekonstruiert." },
        ],
      },
    },
    rooms: {
