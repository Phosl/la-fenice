  ...
  pages: {
    home: {
      ...
      estate: {
        ...
        lead: "La Fenice in the landscape of Positano. Explore the town and coastline, then move closer to the terraces and follow the stairs down to the little cove.",
        study: "Illustrative 3D study · not to scale",
        disclaimer: "The surroundings use open geographic data; building heights, La Fenice’s details and stairs are interpreted, pending on-site footage. This is not a navigation map.",
        posterAlt: "3D coastal landscape of Positano with its town, mountain slopes and La Fenice, from its terraces to the private beach.",
        open: "Explore in 3D", close: "Back to the image", loading: "Preparing the 3D view…",
        error: "The 3D view is unavailable. You can still explore the image and read about each stop.",
        help: "Drag horizontally to rotate. Choose a stop for a closer look, or use the rotate and zoom buttons.",
        reset: "Overview", rotateLeft: "Rotate left", rotateRight: "Rotate right", zoomIn: "Zoom in", zoomOut: "Zoom out",
        stops: [
          { title: "Arrival", text: "The route starts at the road, at the top of the property. From here, steps lead down towards the house." },
          { title: "Rooms and terraces", text: "The buildings follow the hillside. Stairs connect rooms and terraces at different levels." },
          { title: "Gardens and stairs", text: "Flights of steps and landings weave through the greenery. The coloured line is illustrative, not a surveyed route." },
          { title: "The rockside pool", text: "Further down, the seawater pool meets the rock face and surrounding greenery." },
          { title: "The private beach", text: "The descent continues to the small pebble cove at the foot of the cliffs. The return journey is uphill." },
          { title: "Positano and the coast", text: "Look beyond the property towards Positano and the surrounding hills. The coastline and building footprints follow open data; facades and heights are illustrative." },
        ],
      },
    },
    rooms: {
