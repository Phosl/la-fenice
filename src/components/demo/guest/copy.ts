...
export const guestDemoCopy: Record<Locale, GuestCopy> = {
  en: {
    ...
    login: {
      ...
      lead: "Enter your stay code and password to view your dates and send requests to our team.",
      languageLabel: "Language",
      codeLabel: "Stay code",
      codePlaceholder: "e.g. ROSSI-27",
  ...
  it: {
    ...
    login: {
      ...
      lead: "Inserisci il codice soggiorno e la password per vedere le tue date e inviare richieste al nostro staff.",
      languageLabel: "Lingua",
      codeLabel: "Codice soggiorno",
      codePlaceholder: "es. ROSSI-27",
      passwordLabel: "Password",
  ...
  de: {
    ...
    login: {
      ...
      lead: "Geben Sie Ihren Aufenthaltscode und Ihr Passwort ein, um Ihre Reisedaten zu sehen und Anfragen an unser Team zu senden.",
      languageLabel: "Sprache",
      codeLabel: "Aufenthaltscode",
      codePlaceholder: "z. B. ROSSI-27",
  ...
  ru: {
    ...
    login: {
      ...
      lead: "Введите код проживания и пароль, чтобы увидеть даты и отправить запрос нашей команде.",
      languageLabel: "Язык",
      codeLabel: "Код проживания",
      codePlaceholder: "например, ROSSI-27",
